...
const FloatingNav = () => {
  ...
  return (
    <div className="fixed top-6 left-1/2 transform -translate-x-1/2 z-50">
      {/* Main Navigation */}
      <nav className={`${bgColor} ${borderColor} ${shadowColor} backdrop-blur-xl border rounded-full px-8 py-4 shadow-2xl transition-all duration-300`}>
        ...
        {/* Subtle accent line */}
        <div className={`absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-20 h-0.5 ${accentLineColor} rounded-full`} />
      </nav>
    </div>
  );
};
